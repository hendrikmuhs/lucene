...
/**
 * Represents a state in the state hashtable. Since we'll need to save millions of these, we aim to
 * make each object very small.
 */
public final class PackedState implements MinimizationHashEntry {
  ...
  /**
   * Hash entry representing packed states.
   *
   * <p>Note: As this is performance critical the object is re-used
   */
