...
public class TestBitVector extends LuceneTestCase {
  ...
  public void testBitShifting() {
    ...
    a.set(10);
    assertEquals(
        a.getUnderlyingIntegerAtPosition(0, 0), origin.getUnderlyingIntegerAtPosition(0, 0));
    ...
    b.set(8);
    assertEquals(
        b.getUnderlyingIntegerAtPosition(0, 0), origin.getUnderlyingIntegerAtPosition(0, 5));
    ...
    c.set(7);
    assertEquals(
        c.getUnderlyingIntegerAtPosition(0, 0), origin.getUnderlyingIntegerAtPosition(0, 6));
    ...
    d.set(3);
    assertEquals(
        d.getUnderlyingIntegerAtPosition(0, 0), origin.getUnderlyingIntegerAtPosition(0, 10));

    // 0000 0000
    BitVector e = new BitVector(15);
    assertEquals(
        e.getUnderlyingIntegerAtPosition(0, 0), origin.getUnderlyingIntegerAtPosition(0, 15));
  }
